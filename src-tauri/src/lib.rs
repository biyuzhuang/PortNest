...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::mysql_admin::mysql_connect,
            commands::mysql_admin::mysql_disconnect,
            commands::mysql_admin::mysql_list_databases,
            commands::mysql_admin::mysql_list_charsets,
            commands::mysql_admin::mysql_list_tables,
            commands::mysql_admin::mysql_list_columns,
            commands::mysql_admin::mysql_list_indexes,
            commands::mysql_admin::mysql_execute_sql,
            commands::mysql_admin::mysql_fetch_rows,
            commands::mysql_admin::mysql_create_database,
            commands::mysql_admin::mysql_drop_database,
            commands::mysql_admin::mysql_create_table,
            commands::mysql_admin::mysql_preview_table,
            commands::mysql_admin::mysql_apply_table,
            commands::mysql_admin::mysql_table_action,
            commands::mysql_admin::mysql_show_create,
            commands::mysql_admin::mysql_mutate_row,
            commands::mysql_admin::mysql_import_csv,
            commands::mysql_admin::mysql_import_sql,
            commands::mysql_admin::mysql_export_sql,
            ...
            commands::list_sftp_transfers,
            commands::clear_sftp_transfer_history,
            commands::configure_sftp_transfer_queue,
            commands::get_sftp_transfer_queue,
            commands::sftp_retry_transfer,
            commands::sftp_set_permissions,
            commands::sftp_set_owner,
